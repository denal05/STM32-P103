/**
  ******************************************************************************
  * @file SpeexVocoder_STM32_SK/src/stm32f10x_it.c 
...
/*  Add here the Interrupt Handler for the used peripheral(s) (SpeexVocoder_IAR_src), for the  */
/*  available peripheral interrupt handler's name please refer to the startup */
/*  file (startup_stm32f10x_xx.s).                                            */
/******************************************************************************/

/**
  * @brief  This function handles SpeexVocoder_IAR_src interrupt request.
  * @param  None
  * @retval : None
  */
/*void SpeexVocoder_IAR_src_IRQHandler(void)
{
}*/
